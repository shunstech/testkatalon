...
WebUI.click(findTestObject('Page_account - Space Casino/a_Select_Neteller'))

WebUI.setText(findTestObject('Object Repository/Page_account - Space Casino/input_Email_email'), 'test@test.com')

WebUI.setText(findTestObject('Object Repository/Page_account - Space Casino/input_Secureid_secureID'), 'test')
