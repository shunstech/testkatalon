...
WebUI.click(findTestObject('Page_account - Space Casino/a_Select_Card'))
...
WebUI.setText(findTestObject('Object Repository/Page_account - Space Casino/input_Name On Card_nameOnCard'), 'test ninteen')
...
WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/button_Verify Now'))
