...
WebUI.setText(findTestObject('Page_Login - Space Casino/input_usernameemail or phone number_username'), 'nomoneytest')
...
WebUI.click(findTestObject('Page_account - Space Casino/a_Select_Skrill'))
