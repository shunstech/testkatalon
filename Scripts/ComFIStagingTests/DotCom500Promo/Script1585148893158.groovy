...
WebUI.setText(findTestObject('Page_Register - Space Casino/input_Username_username'), 'newuserpromo')

WebUI.setText(findTestObject('Page_Register - Space Casino/input_Email_email'), 'newuserpromo@n.test.spacecasino.com')
...
WebUI.click(findTestObject('Object Repository/Page_Register - Space Casino/label_I agree to the Terms and Conditions a_06dc0c'))
...
WebUI.setText(findTestObject('Page_Register - Space Casino/input_Last name_last_name'), 'promo')

WebUI.click(findTestObject('Page_Register - Space Casino/input_First name_first_name'))

WebUI.setText(findTestObject('Page_Register - Space Casino/input_First name_first_name'), 'newuser')

WebUI.click(findTestObject('Page_Register - Space Casino/input_First name_first_name'))

WebUI.navigateToUrl('https://staging.spacecasino.com/en/sign-up/')

WebUI.setText(findTestObject('Page_Register - Space Casino/input_Date of birth_flatpickr-input active'), '03/03/2002')

WebUI.setText(findTestObject('Page_Register - Space Casino/input_Address_address'), '321 finland')

WebUI.setText(findTestObject('Page_Register - Space Casino/input_City_city'), 'finn')

WebUI.setText(findTestObject('Page_Register - Space Casino/input_Postcode_post_code'), '87645')

WebUI.setText(findTestObject('Page_Register - Space Casino/input_Phone number_phone_number'), '456789123')

WebUI.click(findTestObject('Page_Register - Space Casino/label_female'))
...
WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/a_Select'))

WebUI.setText(findTestObject('Page_account - Space Casino/input_Card Number_cardNumber'), '4012-0003-0000-1003')

WebUI.setText(findTestObject('Page_account - Space Casino/input_Name On Card_nameOnCard'), 'promo test')
