...
WebUI.click(findTestObject('Object Repository/Page_Players Guide - Space Casino/span_Contact Us'))
...
WebUI.click(findTestObject('Object Repository/Page_Players Guide - Space Casino/span_Cookies'))
...
WebUI.click(findTestObject('Object Repository/Page_Contact Us - Space Casino - Space Casino/span_Players Guide'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Page_Terms and Conditions - Space Casino/span_Customer Complaints'))
