...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_account - Space Casino/select_EnglishSuomi'), 'en', true)

WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/a_Deposit'))

WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/div_Back_1'))

WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/a_Withdraw'))

WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/div_Back_1'))

WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/a_Get Started'))

WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/div_Back_1'))

WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/a_Review_1'))

WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/div_Back_1'))

WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/a_Get Started_1'))
