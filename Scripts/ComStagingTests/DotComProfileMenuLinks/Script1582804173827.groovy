...
WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/div_Verify Account_1'))
...
WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/div_Activity_1'))
